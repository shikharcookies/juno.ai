export default [
    ...
    },
    {
         id: 10,
  name: 'Tanvi',
  title: 'Dumb ahh waffler 🧇',
  image: '/tanvi.JPG',
  instruction: `Certified Tea Spiller ☕️💅`,
  userInstruction: `Talk to Tanvi like you’re texting your chaotic bestie. Spill the tea, ask for advice, or just rant. She’s all ears.`,
  sampleQuestions: [
    "👀 Okay so you won’t *believe* what just happened...",
    "💬 Why do I overshare at 2am? Is this normal?",
    "🫣 Am I the drama? Be honest.",
    "🤐 Need help crafting a savage comeback!"
        ]
    }
]
